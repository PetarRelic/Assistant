...
<html>
  ...
  <body>
    ...
    <div>
                    ...
                    <div class="col-md-12">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${obaveze}" var="obaveza">
                                    <tr>
                                        <td>${obaveza.idFilm}</td>
                                        <td>${obaveza.naziv}</td>
                                        <td>${obaveza.zanr}</td>
                                        ...
                                        <td>
                                            <a class="btn btn-block btn-info" data-toggle="modal"
                                               data-target="#modal-obaveza-edit" 
                                               onclick="popuniEditFormu('${obaveza.idFilm}', '${obaveza.naziv}', '${obaveza.zanr}');">
                                                Izmeni..</a>
                                        </td>
                                        ...
                                        <td>
                                            <a class="btn btn-block btn-danger" data-toggle="modal"
                                               data-target="#modal-obaveza-delete" 
                                               onclick="popuniDeleteFormu('${obaveza.idFilm}');">
                                                Obriši..</a>
                                        </td>
                                    </tr>  
                                </c:forEach>
                        ...
                        <a class="btn btn-success pull-right" data-toggle="modal"
                           data-target="#modal-obaveza-add">Novi Film..</a>
                        </br>
                        </br>
                        </br>
                        <div class="row">
        ...
        <div class="modal fade" id="modal-obaveza-add">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                        <h4 class="modal-title">Unesite podatke o obavezau</h4>
                    </div>
                    <div class="modal-body">
                        <form class="form-horizontal" role="form" action="obaveza" method="POST">
        ...
        <div class="modal fade" id="modal-obaveza-edit">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                        <h4 class="modal-title">Izmenite podatke o obavezau</h4>
                    </div>
                    <div class="modal-body">
                        <form class="form-horizontal" role="form" action="obaveza" method="POST">
        ...
        <div class="modal fade" id="modal-obaveza-delete">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                        <h4 class="modal-title">Izbrišite obaveza</h4>

                        <form class="" role="form" action="obaveza" method="POST">
